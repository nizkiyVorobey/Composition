...
fun bindResultEmoji(imageView: ImageView, inWin: Boolean) {
    imageView.setImageResource(getSimpleResId(inWin))
}

private fun getSimpleResId(inWin: Boolean): Int {
    return if (inWin) {
        R.drawable.ic_smile
    } else {
        R.drawable.ic_sad
...
@BindingAdapter("rightPercentProgress")
fun bindRightPercentProgress(progressBar: ProgressBar, progress: Int) {
